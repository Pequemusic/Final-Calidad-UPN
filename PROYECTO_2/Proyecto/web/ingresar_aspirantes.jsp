...
<%@page import="Validaciones.validacionesAspirante"%>
...
<script>
document.title = 'Ingresar aspirantes';    
</script>
<h2>Registro de postulacion</h2>
...
<section class="container clearfix" >
    <form action="" method="get" enctype="multipart/form-data" >
        ...
        <div class="row">
            ...
            <div class="col-75">
                <input type="text" name="dni" onkeypress="return numeros(event)" maxlength="8" id="dni"><br/>
            </div>
        </div>
        <div class="row">
            <div class="col-25">
        ...
        <div class="row">
            ...
            <div class="col-75">
                <input type="text" name="celular" required onkeypress="return numeros(event)" maxlength="9" id="celular"><br/>
            </div>
        </div>
        <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
                <input type="text" name="fijo" required onkeypress="return numeros(event)" maxlength="7" id="fijo"><br/>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-75">
                <input type="date" name="fecha" id="fecha" ><br/> <script>fecha();</script>
            </div>
        </div>
        <div class="row">
            <div class="col-25">
        ...
        <div class="col-75">
            <input type="text" name="hijos" onkeypress="return numeros(event)" maxlength="1" id="hijos"><br/>
        </div>
        </div>
        ...
        <div class="row">
            <input type="submit" value="Enviar" name="btnRegistrar" onclick="return ValidarAspirante();">
        </div>
